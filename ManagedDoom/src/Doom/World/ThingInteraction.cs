...
namespace ManagedDoom
{
    public sealed class ThingInteraction
    {
        ...
        public void KillMobj(Mobj source, Mobj target)
        {
            ...
            Mobj mo = world.ThingAllocation.SpawnMobj(target.X, target.Y, Mobj.OnFloorZ, item);
        ...
        public void DamageMobj(Mobj target, Mobj? inflictor, Mobj? source, int damage)
        {
            ...
            {
                Angle ang = Geometry.PointToAngle(
                    inflictor.X,
                    inflictor.Y,
                    target.X,
                    target.Y);
        ...
        public void RadiusAttack(Mobj spot, Mobj source, int damage)
        {
            ...
            int blockY1 = bm.GetBlockY(spot.Y - dist);
            int blockY2 = bm.GetBlockY(spot.Y + dist);
            int blockX1 = bm.GetBlockX(spot.X - dist);
            int blockX2 = bm.GetBlockX(spot.X + dist);
