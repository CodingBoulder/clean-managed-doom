...
namespace ManagedDoom
{
    public sealed class MapInteraction
    {
        ...
        public void UseLines(Player player)
        {
            ...
            Fixed x1 = player.Mobj.X;
            Fixed y1 = player.Mobj.Y;
            Fixed x2 = x1 + useRange.ToIntFloor() * Trig.Cos(angle);
            Fixed y2 = y1 + useRange.ToIntFloor() * Trig.Sin(angle);
        ...
        {
            Specials specials = world.Specials;
